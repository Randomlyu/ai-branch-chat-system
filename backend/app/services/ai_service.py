...
import pytz
from .title_generator import default_title_generator
...
class AIService:
    ...
    def generate_branch_title(self, parent_message_content: str, thread_count: int, depth: int) -> str:
        ...
        Returns:
            生成的标题
        """
        return default_title_generator.generate_title(
            ai_content=parent_message_content,
